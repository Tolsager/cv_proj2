...
if __name__ == '__main__':
    ...
    model.to(device)
    model.eval()
    model.load_state_dict(torch.load('exercise2/weights/classifier/model.pth', map_location=device))
    ...
    plt.savefig('exercise2/assets/per_t_accuracy.png', bbox_inches='tight')
    ...
    show_n_forward(vis_images, fig_titles=vis_labels, save_path='exercise2/assets/clf_forward.png')
